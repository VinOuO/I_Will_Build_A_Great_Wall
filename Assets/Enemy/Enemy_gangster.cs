...
public class Enemy_gangster : MonoBehaviour
{
    //--------------------------------------stytle
    ...
    void Update()
    {
        ...
        else
        {
            ...
            size += s;
            if (drop == false && transform.position.y >= 0)
            {
                Instantiate(GameObject.Find("gun_p"), transform.position, GameObject.Find("gun_p").transform.rotation);
                drop = true;
            }
